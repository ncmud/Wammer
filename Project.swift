...
let project = Project(
    ...
    packages: [
        ...
        .local(path: "Vendored/TOWebViewController"),
    ...
    targets: [
        .target(
            ...
            destinations: .iOS,
            product: .app,
            bundleId: "com.PLACEHOLDER.mudrammer",
            ...
            dependencies: [
                ...
                .package(product: "TOWebViewController"),
        ...
        .target(
            ...
            destinations: .iOS,
            product: .unitTests,
            bundleId: "com.PLACEHOLDER.mudrammer.tests",
            infoPlist: "src/MRTests/MRTests-Info.plist",
            sources: [
                "src/MRTests/**",
            ],
            dependencies: [
                .target(name: "MUDRammer"),
