...
@interface QImageElement () <UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIPopoverPresentationControllerDelegate>
...
- (void)presentImagePicker:(QuickDialogTableView *)tableView controller:(QuickDialogController *)controller path:(NSIndexPath *)path {
    ...
    if (isPhone) {
        ...
        if ([tableViewCell isKindOfClass:[QImageTableViewCell class]]) {
            ...
            UIPopoverPresentationController *popover = self.imagePickerController.popoverPresentationController;
            popover.sourceView = presentingView;
            popover.sourceRect = presentingView.bounds;
            popover.permittedArrowDirections = UIPopoverArrowDirectionAny;
            popover.delegate = self;
            self.popoverController = self.imagePickerController;
